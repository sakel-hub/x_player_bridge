...
def main():
    ...
    artifact_dir = "/Users/juraj/.gemini/antigravity-ide/brain/e9b4ff77-f440-420a-9ea8-c1bf7c75af8d"
    if os.path.isdir(artifact_dir):
        artifact_path = os.path.join(artifact_dir, "screenshot.png")
