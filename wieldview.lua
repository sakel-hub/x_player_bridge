...
core.log("action", "[" .. modname .. "] Initializing wieldview dynamic bridge hooks")
...
if x_player_api and x_player_api.set_wield_item_enabled then
...
local function on_ready()
	init_wieldview_hooks()
	local enable_3d = (x_player_api and x_player_api.enable_wield_item == true)
	apply_wieldview_state(enable_3d, false)
end

core.register_on_mods_loaded(on_ready)
