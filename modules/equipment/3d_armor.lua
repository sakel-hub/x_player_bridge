--- 3d_armor integration module for x_player_bridge
--- Registers dual-format character models and synchronizes composited armor textures to proxies.
...
x_player_bridge.register_module("3d_armor", {
	description = "Registers 3d_armor dual-model character and synchronizes armor textures to visual proxies",
	required_mods = { "3d_armor" },
	setting = "x_player_bridge.enable_3d_armor",
